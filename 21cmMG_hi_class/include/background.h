...
enum gravity_model {propto_omega, propto_scale, eft_alphas_power_law, eft_gammas_power_law, eft_gammas_exponential, constant, tanh_scale, hill_scale, oscillation_scale, gaussian_scale, scale_early_late, arctan}; //write here the different models
