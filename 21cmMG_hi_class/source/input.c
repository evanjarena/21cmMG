...
int input_read_parameters(
  ...
  if (pba->Omega0_smg != 0.) {
	...
	class_read_list_of_doubles("parameters_smg",pba->parameters_2_smg,pba->parameters_2_size_smg);
      ...
      if (strcmp(string1,"constant") == 0) {
	pba->gravity_model_smg = constant;
	pba->field_evolution_smg = _FALSE_;
	pba->M_pl_evolution_smg = _TRUE_;
	flag2=_TRUE_;
	pba->parameters_2_size_smg = 5;
	class_read_list_of_doubles("parameters_smg",pba->parameters_2_smg,pba->parameters_2_size_smg);
      ...
      if (strcmp(string1,"tanh_scale") == 0) {
	pba->gravity_model_smg = tanh_scale;
	pba->field_evolution_smg = _FALSE_;
	pba->M_pl_evolution_smg = _TRUE_;
	flag2=_TRUE_;
	pba->parameters_2_size_smg = 11;
	class_read_list_of_doubles("parameters_smg",pba->parameters_2_smg,pba->parameters_2_size_smg);
      }

      if (strcmp(string1,"hill_scale") == 0) {
	pba->gravity_model_smg = hill_scale;
	pba->field_evolution_smg = _FALSE_;
	pba->M_pl_evolution_smg = _TRUE_;
	flag2=_TRUE_;
	...
	class_read_list_of_doubles("parameters_smg",pba->parameters_2_smg,pba->parameters_2_size_smg);
      ...
      if (strcmp(string1,"oscillation_scale") == 0) {
	pba->gravity_model_smg = oscillation_scale;
	pba->field_evolution_smg = _FALSE_;
	pba->M_pl_evolution_smg = _TRUE_;
	flag2=_TRUE_;
	pba->parameters_2_size_smg = 7;
	class_read_list_of_doubles("parameters_smg",pba->parameters_2_smg,pba->parameters_2_size_smg);
      ...
      if (strcmp(string1,"gaussian_scale") == 0) {
	pba->gravity_model_smg = gaussian_scale;
	pba->field_evolution_smg = _FALSE_;
	pba->M_pl_evolution_smg = _TRUE_;
	flag2=_TRUE_;
	pba->parameters_2_size_smg = 7;
	class_read_list_of_doubles("parameters_smg",pba->parameters_2_smg,pba->parameters_2_size_smg);
      ...
      if (strcmp(string1,"scale_early_late") == 0) {
	pba->gravity_model_smg = scale_early_late;
	pba->field_evolution_smg = _FALSE_;
	pba->M_pl_evolution_smg = _TRUE_;
	flag2=_TRUE_;
	pba->parameters_2_size_smg = 11;
	class_read_list_of_doubles("parameters_smg",pba->parameters_2_smg,pba->parameters_2_size_smg);
      ...
      if (strcmp(string1,"arctan") == 0) {
	pba->gravity_model_smg = arctan;
	pba->field_evolution_smg = _FALSE_;
	pba->M_pl_evolution_smg = _TRUE_;
	flag2=_TRUE_;
	pba->parameters_2_size_smg = 11;
	class_read_list_of_doubles("parameters_smg",pba->parameters_2_smg,pba->parameters_2_size_smg);
      ...
      class_test(flag2==_FALSE_,
		 errmsg,
		 "could not identify gravity_theory value, check that it is one of 'propto_omega', 'propto_scale', 'eft_alphas_power_law', 'eft_gammas_power_law', 'eft_gammas_exponential', 'constant', 'tanh_scale', 'hill_scale', 'oscillation_scale', 'gaussian_scale', 'scale_early_late', 'arctan' ...");
